...
# Below logic can be changed if you want to bias the experiments differently
REUSE_LOGIC_PROGRAM = False
RELEVANCE_SCORES = {
    # predicates
    # Reward patterns with a specific condition in mind (if there is one)
    'compound_name': 5,
    # Reward patterns with a specific chemical in mind (if there is one)
    'condition': 10,
...
# How many sample-blocks (blank, qc, sample, qc, blank) to have inbetween reference tuning injections
TUNE_INTERVAL = 0
