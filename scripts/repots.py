...
if __name__ == '__main__':
    ...
    # Hypothesis text
    file_path = "/Users/danbru/Library/CloudStorage/OneDrive-Chalmers/Desktop/GenExp/experiments/completed_experiments/aminoadipate_202504291411/hypothesis/selected_hypothesis/hypothesis.txt"
    ...
    df_metabolites = pd.read_csv('/Users/danbru/Library/CloudStorage/OneDrive-Chalmers/Desktop/GenExp/experiments/completed_experiments/aminoadipate_202504291411/results/metabolomics/coefficients/supp_stats.csv', sep = '\t')
    ...
    sections = [
        {
            ...
            "text": file_content,
            "figures": [],
            "tables": [(df_growth_stats, 'Summary statistics'),
                       (df_target, 'Metabolites')]
        },
        {
            "title": "Growth Data",
        ...
        },
        {
            ...
            "text": "Overview of metabolomics results...",
            "figures": [],
